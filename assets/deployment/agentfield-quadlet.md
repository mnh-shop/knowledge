...
tags: [agentfield, quadlet, golang, control-plane, identity, orchestration, harness, systemd, container, security, ai-llm, cli, deployment, docker, mcp, monitoring, storage, webhook]
