---
name: sec-af-profile
tags: [adversarial, agent-profile, ai-llm, auditor, automation, cli, container, git, monitoring, optimization, orchestration, plugin-sdk, profile, python, sec-af, security]
