...
```text
sources/       full cloned GitHub repositories (gitignored, 122 repos)
raw/           Repomix XML generated from repositories (122 repos)
...
The table below tracks all indexed repositories and their corresponding vault locations. Generated from actual filesystem state — 122 sources, 122 wikis (+4 pending generation), 122 codegraph-verify pages (+4 pending), 122 raw exports, 122 codegraph indexes.
...
| NotFair | [[NotFair]] | sources/NotFair/ | raw/NotFair/ | graphs/NotFair/ | |
...
| appstore | [[appstore]] | sources/appstore/ | raw/appstore/ | graphs/appstore/ | |
...
**Key:** 4 wiki pages currently being generated for new repos (claude-ads, firecracker, floci, hyperframes).
