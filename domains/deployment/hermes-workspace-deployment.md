...
tags: [hermes, deployment, typescript, agent-gateway, messaging, multi-platform, container, ai-llm, automation, cli, dashboard, desktop-app, docker, event-bus, mcp, nix, plugin-sdk, quadlet, security, systemd]
