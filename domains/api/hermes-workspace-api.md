...
tags: [hermes, api, typescript, agent-gateway, messaging, multi-platform, rest-api, acp, ai-llm, container, dashboard, desktop-app, event-bus, mcp, orchestration, plugin-sdk, quadlet, security, storage, systemd]
