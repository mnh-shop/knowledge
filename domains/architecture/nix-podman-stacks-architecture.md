...
type: architecture
tags: [architecture, automation, cli, container, dashboard, docker, git, home-manager, infrastructure-as-code, monitoring, nix, nix-podman-stacks, podman, quadlet, self-hosted-stacks, storage, systemd, virtualization]
