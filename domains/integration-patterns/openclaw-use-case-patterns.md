...
description: "Catalog of 42 OpenClaw use case patterns across 9 domains: productivity, content creation, communication, DevOps, research, finance, social media, development, and multi-domain"
tags: [automation, cli, dashboard, desktop, documentation, event-bus, git, mcp, messaging, monitoring, orchestration, plugin-sdk, storage, openclaw]
...
- [[awesome-openclaw-usecases]] -- Source repository
- [[awesome-openclaw-skills]] -- Skill categories reference
- [[openclaw]] -- OpenClaw wiki entry
- [[hermes-profiles]] -- Hermes role profiles (different concept)