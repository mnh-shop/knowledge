...
- **Wiki says:** Six interactive skills shipped in `.claude/skills/`: /quickstart, /threat-model, /vuln-scan, /triage, /patch, /customize.
- **Source evidence:**
...
## Claim 5: Four shipped targets including canary and real-world CVE targets
- **Wiki says:** Ships four targets: canary (fast smoke test), drlibs, alsa, and htslib (real-world CVE demo targets with pinned vulnerable commits).
- **Source evidence:**
...
All 6 key claims from the defending-code-reference-harness wiki have been verified against the source code:
...
- ✅ 6 interactive skills: /quickstart, /threat-model, /vuln-scan, /triage, /patch, /customize all present
- ✅ gVisor sandboxing: Dual-container trust boundary confirmed with sandbox scripts
- ✅ Four shipped targets: canary, drlibs, alsa, htslib all present with CVE documentation
